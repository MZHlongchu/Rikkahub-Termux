    ...
    configurations.configureEach {
        resolutionStrategy.eachDependency {
            when ("${requested.group}:${requested.name}") {
                ...
                "io.netty:netty-codec-http" -> useVersion("4.1.135.Final")
                "io.netty:netty-codec-http2" -> useVersion("4.1.135.Final")
                "io.netty:netty-codec-socks" -> useVersion("4.1.135.Final")
                "io.netty:netty-common" -> useVersion("4.1.135.Final")
                "io.netty:netty-handler" -> useVersion("4.1.135.Final")
                "io.netty:netty-handler-proxy" -> useVersion("4.1.135.Final")
                "io.netty:netty-resolver" -> useVersion("4.1.135.Final")
                "io.netty:netty-transport" -> useVersion("4.1.135.Final")
