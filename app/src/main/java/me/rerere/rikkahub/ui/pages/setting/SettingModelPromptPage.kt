...
internal fun PromptSettingsPage(settings: Settings, vm: SettingVM, contentPadding: PaddingValues) {
    ...
    val translationProvider = translationModel?.findProvider(settings.providers)
    ...
    LazyColumn(
        ...
        item {
            PromptSettingItem(
                ...
                onUpdateReasoningSummary = { vm.updateSettings(settings.copy(translateReasoningSummary = it)) },
